        ...
        <li class="flex flex-row justify-between w-full gap-5 h-full items-center py-3 shadow-xl border px-3">
          ...
          <div class="flex flex-row text-2xl gap-5 h-full items-center justify-between w-2/5">
            ...
            <div class="flex flex-row justify-center gap-5 w-1/5">
              <p class="w-7 bg-col1 text-col4 rounded text-center">{content[1].score_home || content[1].score_home == 0 ? content[1].score_home : ''}</p>
              <p class="w-7 bg-col1 text-col4 rounded text-center">{content[1].score_away || content[1].score_away == 0 ? content[1].score_away : ''}</p>
            </div>
