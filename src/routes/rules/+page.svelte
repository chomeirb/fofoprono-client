<div class="flex flex-col items-center justify-center m8:justify-start px-3 pt-3 m8:pt-0 w-full h-full">
    <div class="text-4xl flex flex-row justify-start m12:justify-center m8:py-2 items-center w-full max-w-8xl w-full h-[10%]">
        <p class="font-bold">RÈGLES DU JEU</p>
    </div>
    <div class="flex flex-col justify-start w-full max-w-8xl px-3 m12:px-4 mt-5 m8:mt-0 mb-10 shadow-in text-2xl gap-8 p-8 h-full overflow-y-auto m12:text-lg rounded-md">
