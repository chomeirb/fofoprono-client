...
<svg class={style} {width} {height} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <g style={`fill: ${color};`} stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
